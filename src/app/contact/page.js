        ...
        <div className="flex mx-24 my-10">
            ...
            <div className="flex flex-col space-y-6 mx-20">
                ...
                <button
                    ...
                    className="text-white bg-blue-400 rounded-lg py-3 text-lg transition-all duration-200 hover:bg-blue-600 hover:tracking-wide"
                >
                    Send Message
                </button>
                {success && <div className="text-green-600 text-center p-3 bg-green-200 rounded-xl">Message sent successfully!</div>}
            </div>
        </div>
    );
}