...
export default function HomePage() {
    ...
    return(<div className="container mx-auto">
        ...
        style={{
            ...
            <button className="group mt-[200px] px-6 py-3 bg-yellow-400 font-semibold text-gray-50 transition duration-300 ease-in-out cursor-pointer flex items-center justify-center relative overflow-hidden z-40" onClick={()=> navigateTo('/product-store/')}>
            ...
            <div className="flex justify-center items-center m-auto">
                <div className="flex flex-col justify-center items-start w-1/4 h-full p-4 m-2">
                    ...
                    <div className="group flex justify-center items-center w-fit my-1">
                        <button className="relative text-lg text-medium text-blue-500" onClick={() => navigateTo('/product-store/')}>
                                See More
